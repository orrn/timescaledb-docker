...
CREATE  FUNCTION "uddsketch_trans"(
...
CREATE  FUNCTION "uddsketch_serialize"(
	"state" internal /* pgrx::datum::internal::Internal */
...
CREATE  FUNCTION "uddsketch_deserialize"(
...
CREATE  FUNCTION "uddsketch_combine"(
...
CREATE  FUNCTION "timevector_tstz_f64_trans"(
	"state" internal, /* pgrx::datum::internal::Internal */
...
CREATE  FUNCTION "timevector_serialize"(
	"state" internal /* pgrx::datum::internal::Internal */
) RETURNS bytea /* timescaledb_toolkit::raw::bytea */
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "timevector_deserialize"(
	"bytes" bytea, /* timescaledb_toolkit::raw::bytea */
	"_internal" internal /* pgrx::datum::internal::Internal */
) RETURNS internal /* core::option::Option<pgrx::datum::internal::Internal> */
IMMUTABLE STRICT PARALLEL SAFE
...
CREATE  FUNCTION "timevector_combine"(
	"state1" internal, /* pgrx::datum::internal::Internal */
	"state2" internal /* pgrx::datum::internal::Internal */
) RETURNS internal /* core::option::Option<pgrx::datum::internal::Internal> */
IMMUTABLE PARALLEL SAFE
...
CREATE  FUNCTION "time_weight_trans_serialize"(
	"state" internal /* pgrx::datum::internal::Internal */
) RETURNS bytea /* timescaledb_toolkit::raw::bytea */
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "time_weight_trans_deserialize"(
	"bytes" bytea, /* timescaledb_toolkit::raw::bytea */
	"_internal" internal /* pgrx::datum::internal::Internal */
) RETURNS internal /* core::option::Option<pgrx::datum::internal::Internal> */
IMMUTABLE STRICT PARALLEL SAFE
...
CREATE  FUNCTION "time_weight_trans"(
	"state" internal, /* pgrx::datum::internal::Internal */
...
CREATE  FUNCTION "time_weight_combine"(
	"state1" internal, /* pgrx::datum::internal::Internal */
	"state2" internal /* pgrx::datum::internal::Internal */
) RETURNS internal /* core::option::Option<pgrx::datum::internal::Internal> */
IMMUTABLE PARALLEL SAFE
...
CREATE  FUNCTION "tick_data_transition"(
	"state" internal, /* pgrx::datum::internal::Internal */
	"ts" TimestampTz, /* core::option::Option<timescaledb_toolkit::raw::TimestampTz> */
...
CREATE  FUNCTION "tick_data_no_vol_transition"(
	"state" internal, /* pgrx::datum::internal::Internal */
	"ts" TimestampTz, /* core::option::Option<timescaledb_toolkit::raw::TimestampTz> */
	"price" double precision /* core::option::Option<f64> */
) RETURNS internal /* core::option::Option<pgrx::datum::internal::Internal> */
...
CREATE  FUNCTION "tdigest_serialize"(
	"state" internal /* pgrx::datum::internal::Internal */
) RETURNS bytea /* timescaledb_toolkit::raw::bytea */
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "tdigest_deserialize"(
	"bytes" bytea, /* timescaledb_toolkit::raw::bytea */
	"_internal" internal /* pgrx::datum::internal::Internal */
) RETURNS internal /* core::option::Option<pgrx::datum::internal::Internal> */
IMMUTABLE STRICT PARALLEL SAFE
...
CREATE  FUNCTION "tdigest_compound_serialize"(
	"state" internal /* pgrx::datum::internal::Internal */
) RETURNS bytea /* timescaledb_toolkit::raw::bytea */
IMMUTABLE PARALLEL SAFE
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "tdigest_compound_deserialize"(
	"bytes" bytea, /* timescaledb_toolkit::raw::bytea */
	"_internal" internal /* pgrx::datum::internal::Internal */
) RETURNS internal /* core::option::Option<pgrx::datum::internal::Internal> */
IMMUTABLE PARALLEL SAFE
...
CREATE  FUNCTION "tdigest_compound_combine"(
	"state1" internal, /* pgrx::datum::internal::Internal */
	"state2" internal /* pgrx::datum::internal::Internal */
) RETURNS internal /* core::option::Option<pgrx::datum::internal::Internal> */
IMMUTABLE PARALLEL SAFE
...
CREATE  FUNCTION "tdigest_combine"(
	"state1" internal, /* pgrx::datum::internal::Internal */
	"state2" internal /* pgrx::datum::internal::Internal */
) RETURNS internal /* core::option::Option<pgrx::datum::internal::Internal> */
IMMUTABLE PARALLEL SAFE
...
CREATE  FUNCTION "stats2d_trans_serialize"(
	"state" internal /* pgrx::datum::internal::Internal */
) RETURNS bytea /* timescaledb_toolkit::raw::bytea */
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "stats2d_trans_deserialize"(
	"bytes" bytea, /* timescaledb_toolkit::raw::bytea */
	"_internal" internal /* pgrx::datum::internal::Internal */
) RETURNS internal /* core::option::Option<pgrx::datum::internal::Internal> */
IMMUTABLE STRICT PARALLEL SAFE
...
CREATE  FUNCTION "stats2d_inv_trans"(
	"state" internal, /* pgrx::datum::internal::Internal */
	"y" double precision, /* core::option::Option<f64> */
	"x" double precision /* core::option::Option<f64> */
) RETURNS internal /* core::option::Option<pgrx::datum::internal::Internal> */
...
CREATE  FUNCTION "stats2d_combine"(
	"state1" internal, /* pgrx::datum::internal::Internal */
	"state2" internal /* pgrx::datum::internal::Internal */
) RETURNS internal /* core::option::Option<pgrx::datum::internal::Internal> */
IMMUTABLE PARALLEL SAFE
...
CREATE  FUNCTION "stats1d_trans_serialize"(
	"state" internal /* pgrx::datum::internal::Internal */
) RETURNS bytea /* timescaledb_toolkit::raw::bytea */
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "stats1d_trans_deserialize"(
	"bytes" bytea, /* timescaledb_toolkit::raw::bytea */
	"_internal" internal /* pgrx::datum::internal::Internal */
) RETURNS internal /* core::option::Option<pgrx::datum::internal::Internal> */
IMMUTABLE STRICT PARALLEL SAFE
...
CREATE  FUNCTION "stats1d_inv_trans"(
	"state" internal, /* pgrx::datum::internal::Internal */
	"val" double precision /* core::option::Option<f64> */
) RETURNS internal /* core::option::Option<pgrx::datum::internal::Internal> */
IMMUTABLE
...
CREATE  FUNCTION "stats1d_combine"(
	"state1" internal, /* pgrx::datum::internal::Internal */
	"state2" internal /* pgrx::datum::internal::Internal */
) RETURNS internal /* core::option::Option<pgrx::datum::internal::Internal> */
IMMUTABLE PARALLEL SAFE
...
CREATE  FUNCTION "state_agg_transition_fn_outer"(
...
CREATE  FUNCTION "state_agg_int_trans"(
	"__inner" internal, /* pgrx::datum::internal::Internal */
	"ts" TimestampTz, /* timescaledb_toolkit::raw::TimestampTz */
...
CREATE  FUNCTION "percentile_agg_trans"(
	"state" internal, /* pgrx::datum::internal::Internal */
	"value" double precision /* core::option::Option<f64> */
) RETURNS internal /* core::option::Option<pgrx::datum::internal::Internal> */
IMMUTABLE PARALLEL SAFE
...
CREATE  FUNCTION "min_n_time_trans"(
	"state" internal, /* pgrx::datum::internal::Internal */
...
CREATE  FUNCTION "min_n_by_time_trans"(
	"state" internal, /* pgrx::datum::internal::Internal */
	"value" TimestampTz, /* timescaledb_toolkit::raw::TimestampTz */
...
CREATE  FUNCTION "mcv_agg_with_skew_trans"(
	"state" internal, /* pgrx::datum::internal::Internal */
	"n" INT, /* i32 */
...
CREATE  FUNCTION "mcv_agg_with_skew_text_trans"(
	"state" internal, /* pgrx::datum::internal::Internal */
	"n" INT, /* i32 */
	"skew" double precision, /* f64 */
...
CREATE  FUNCTION "mcv_agg_with_skew_bigint_trans"(
	"state" internal, /* pgrx::datum::internal::Internal */
	"n" INT, /* i32 */
	"skew" double precision, /* f64 */
	"value" bigint /* core::option::Option<i64> */
...
CREATE  FUNCTION "mcv_agg_text_trans"(
	"state" internal, /* pgrx::datum::internal::Internal */
	"n" INT, /* i32 */
	"value" text /* core::option::Option<timescaledb_toolkit::raw::text> */
) RETURNS internal /* core::option::Option<pgrx::datum::internal::Internal> */
...
CREATE  FUNCTION "mcv_agg_bigint_trans"(
	"state" internal, /* pgrx::datum::internal::Internal */
	"n" INT, /* i32 */
	"value" bigint /* core::option::Option<i64> */
) RETURNS internal /* core::option::Option<pgrx::datum::internal::Internal> */
...
CREATE  FUNCTION "max_n_time_trans"(
	"state" internal, /* pgrx::datum::internal::Internal */
	"value" TimestampTz, /* timescaledb_toolkit::raw::TimestampTz */
	"capacity" bigint /* i64 */
) RETURNS internal /* core::option::Option<pgrx::datum::internal::Internal> */
...
CREATE  FUNCTION "max_n_by_time_trans"(
	"state" internal, /* pgrx::datum::internal::Internal */
	"value" TimestampTz, /* timescaledb_toolkit::raw::TimestampTz */
	"data" anyelement, /* pgrx::datum::anyelement::AnyElement */
	"capacity" bigint /* i64 */
...
CREATE  FUNCTION "hyperloglog_trans"(
	"state" internal, /* pgrx::datum::internal::Internal */
	"size" INT, /* i32 */
...
CREATE  FUNCTION "hyperloglog_serialize"(
	"state" internal /* pgrx::datum::internal::Internal */
) RETURNS bytea /* timescaledb_toolkit::raw::bytea */
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "hyperloglog_deserialize"(
	"bytes" bytea, /* timescaledb_toolkit::raw::bytea */
	"_internal" internal /* pgrx::datum::internal::Internal */
) RETURNS internal /* core::option::Option<pgrx::datum::internal::Internal> */
IMMUTABLE STRICT PARALLEL SAFE
...
CREATE  FUNCTION "hyperloglog_combine"(
	"state1" internal, /* pgrx::datum::internal::Internal */
	"state2" internal /* pgrx::datum::internal::Internal */
) RETURNS internal /* core::option::Option<pgrx::datum::internal::Internal> */
IMMUTABLE PARALLEL SAFE
...
CREATE  FUNCTION "heartbeat_trans"(
	"state" internal, /* pgrx::datum::internal::Internal */
...
CREATE  FUNCTION "counter_summary_trans_serialize"(
	"state" internal /* pgrx::datum::internal::Internal */
) RETURNS bytea /* timescaledb_toolkit::raw::bytea */
IMMUTABLE STRICT PARALLEL SAFE
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "counter_summary_trans_deserialize"(
	"bytes" bytea, /* timescaledb_toolkit::raw::bytea */
	"_internal" internal /* pgrx::datum::internal::Internal */
) RETURNS internal /* core::option::Option<pgrx::datum::internal::Internal> */
IMMUTABLE STRICT PARALLEL SAFE
...
CREATE  FUNCTION "counter_agg_trans_no_bounds"(
	"state" internal, /* pgrx::datum::internal::Internal */
	"ts" TimestampTz, /* core::option::Option<timescaledb_toolkit::raw::TimestampTz> */
	"val" double precision /* core::option::Option<f64> */
) RETURNS internal /* core::option::Option<pgrx::datum::internal::Internal> */
...
CREATE  FUNCTION "counter_agg_trans"(
	"state" internal, /* pgrx::datum::internal::Internal */
	"ts" TimestampTz, /* core::option::Option<timescaledb_toolkit::raw::TimestampTz> */
	"val" double precision, /* core::option::Option<f64> */
...
CREATE  FUNCTION "counter_agg_combine"(
	"state1" internal, /* pgrx::datum::internal::Internal */
	"state2" internal /* pgrx::datum::internal::Internal */
) RETURNS internal /* core::option::Option<pgrx::datum::internal::Internal> */
IMMUTABLE PARALLEL SAFE
...
CREATE TYPE UddSketch (
	...
	INPUT = uddsketch_in, /* timescaledb_toolkit::uddsketch::uddsketch_in */
	OUTPUT = uddsketch_out, /* timescaledb_toolkit::uddsketch::uddsketch_out */
	STORAGE = extended
);
...
CREATE  FUNCTION "uddsketch_compound_trans"(
	"state" internal, /* pgrx::datum::internal::Internal */
...
CREATE  FUNCTION "uddsketch_final"(
	"state" internal /* pgrx::datum::internal::Internal */
) RETURNS UddSketch /* core::option::Option<timescaledb_toolkit::uddsketch::UddSketch> */
IMMUTABLE PARALLEL SAFE
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "approx_percentile_rank"(
	"value" double precision, /* f64 */
	"sketch" UddSketch /* timescaledb_toolkit::uddsketch::UddSketch */
) RETURNS double precision /* f64 */
IMMUTABLE STRICT PARALLEL SAFE 
...
CREATE  FUNCTION "approx_percentile"(
...
CREATE  FUNCTION "approx_percentile_array"(
...
CREATE TYPE Timevector_TSTZ_F64;

-- extension/src/time_vector.rs:31
-- timescaledb_toolkit::time_vector::timevector_tstz_f64_in
CREATE  FUNCTION "timevector_tstz_f64_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "timevector_tstz_f64_out"(
...
CREATE TYPE Timevector_TSTZ_F64 (
	INTERNALLENGTH = variable,
	INPUT = timevector_tstz_f64_in, /* timescaledb_toolkit::time_vector::timevector_tstz_f64_in */
	OUTPUT = timevector_tstz_f64_out, /* timescaledb_toolkit::time_vector::timevector_tstz_f64_out */
	STORAGE = extended
);

-- extension/src/time_vector.rs:112
-- timescaledb_toolkit::time_vector::unnest
CREATE  FUNCTION "unnest"(
...
CREATE  FUNCTION "timevector_tstz_f64_compound_trans"(
	"state" internal, /* pgrx::datum::internal::Internal */
...
CREATE  FUNCTION "timevector_final"(
	"state" internal /* pgrx::datum::internal::Internal */
) RETURNS Timevector_TSTZ_F64 /* core::option::Option<timescaledb_toolkit::time_vector::Timevector_TSTZ_F64> */
IMMUTABLE PARALLEL SAFE
LANGUAGE c /* Rust */
...
CREATE TYPE TimeWeightSummary;

-- extension/src/time_weighted_average.rs:30
-- timescaledb_toolkit::time_weighted_average::timeweightsummary_in
CREATE  FUNCTION "timeweightsummary_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "timeweightsummary_out"(
...
CREATE TYPE TimeWeightSummary (
	INTERNALLENGTH = variable,
	INPUT = timeweightsummary_in, /* timescaledb_toolkit::time_weighted_average::timeweightsummary_in */
	OUTPUT = timeweightsummary_out, /* timescaledb_toolkit::time_weighted_average::timeweightsummary_out */
	STORAGE = extended
);

-- extension/src/time_weighted_average.rs:225
-- timescaledb_toolkit::time_weighted_average::time_weight_summary_trans
CREATE  FUNCTION "time_weight_summary_trans"(
	"state" internal, /* pgrx::datum::internal::Internal */
...
CREATE  FUNCTION "interpolated_average"(
...
CREATE  FUNCTION "time_weight_final"(
	"state" internal /* pgrx::datum::internal::Internal */
) RETURNS TimeWeightSummary /* core::option::Option<timescaledb_toolkit::time_weighted_average::TimeWeightSummary> */
IMMUTABLE PARALLEL SAFE
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "interpolated_integral"(
	"tws" TimeWeightSummary, /* core::option::Option<timescaledb_toolkit::time_weighted_average::TimeWeightSummary> */
	"start" TimestampTz, /* timescaledb_toolkit::raw::TimestampTz */
...
CREATE TYPE TDigest (
	INTERNALLENGTH = variable,
	INPUT = tdigest_in, /* timescaledb_toolkit::tdigest::tdigest_in */
	OUTPUT = tdigest_out, /* timescaledb_toolkit::tdigest::tdigest_out */
	STORAGE = extended
);
...
CREATE  FUNCTION "tdigest_compound_final"(
	"state" internal /* pgrx::datum::internal::Internal */
) RETURNS TDigest /* core::option::Option<timescaledb_toolkit::tdigest::TDigest> */
IMMUTABLE PARALLEL SAFE
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "tdigest_compound_trans"(
	"state" internal, /* pgrx::datum::internal::Internal */
...
CREATE TYPE StatsSummary2D;

-- extension/src/stats_agg.rs:40
-- timescaledb_toolkit::stats_agg::statssummary2d_in
CREATE  FUNCTION "statssummary2d_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "statssummary2d_out"(
...
CREATE TYPE StatsSummary2D (
	INTERNALLENGTH = variable,
	INPUT = statssummary2d_in, /* timescaledb_toolkit::stats_agg::statssummary2d_in */
	OUTPUT = statssummary2d_out, /* timescaledb_toolkit::stats_agg::statssummary2d_out */
	STORAGE = extended
);

-- extension/src/stats_agg.rs:1242
-- timescaledb_toolkit::stats_agg::kurtosis_x
CREATE  FUNCTION "kurtosis_x"(
...
CREATE  FUNCTION "stats2d_summary_trans"(
	"state" internal, /* pgrx::datum::internal::Internal */
...
CREATE  FUNCTION "determination_coeff"(
	"summary" StatsSummary2D /* timescaledb_toolkit::stats_agg::StatsSummary2D */
) RETURNS double precision /* core::option::Option<f64> */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "stats2d_summary_inv_trans"(
	"state" internal, /* pgrx::datum::internal::Internal */
	"value" StatsSummary2D /* core::option::Option<timescaledb_toolkit::stats_agg::StatsSummary2D> */
) RETURNS internal /* core::option::Option<pgrx::datum::internal::Internal> */
IMMUTABLE PARALLEL SAFE
...
CREATE TYPE StatsSummary1D;

-- extension/src/stats_agg.rs:29
-- timescaledb_toolkit::stats_agg::statssummary1d_in
CREATE  FUNCTION "statssummary1d_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "statssummary1d_out"(
...
CREATE TYPE StatsSummary1D (
	INTERNALLENGTH = variable,
	INPUT = statssummary1d_in, /* timescaledb_toolkit::stats_agg::statssummary1d_in */
	OUTPUT = statssummary1d_out, /* timescaledb_toolkit::stats_agg::statssummary1d_out */
	STORAGE = extended
);

-- extension/src/stats_agg.rs:1004
-- timescaledb_toolkit::stats_agg::skewness
CREATE  FUNCTION "skewness"(
...
CREATE  FUNCTION "stats1d_summary_trans"(
	"state" internal, /* pgrx::datum::internal::Internal */
...
CREATE  FUNCTION "stats1d_summary_inv_trans"(
	"state" internal, /* pgrx::datum::internal::Internal */
	"value" StatsSummary1D /* core::option::Option<timescaledb_toolkit::stats_agg::StatsSummary1D> */
) RETURNS internal /* core::option::Option<pgrx::datum::internal::Internal> */
IMMUTABLE PARALLEL SAFE
...
CREATE  FUNCTION "interpolated_duration_in"(
...
CREATE  FUNCTION "interpolated_state_int_timeline"(
	"agg" StateAgg, /* core::option::Option<timescaledb_toolkit::state_aggregate::StateAgg> */
	"start" TimestampTz, /* timescaledb_toolkit::raw::TimestampTz */
	"interval" Interval, /* timescaledb_toolkit::raw::Interval */
	"prev" StateAgg /* core::option::Option<timescaledb_toolkit::state_aggregate::StateAgg> */
...
CREATE  FUNCTION "interpolated_state_periods"(
	"agg" StateAgg, /* core::option::Option<timescaledb_toolkit::state_aggregate::StateAgg> */
	"state" TEXT, /* alloc::string::String */
	"start" TimestampTz, /* timescaledb_toolkit::raw::TimestampTz */
	"interval" Interval, /* timescaledb_toolkit::raw::Interval */
...
CREATE  FUNCTION "interpolated_state_timeline"(
	"agg" StateAgg, /* core::option::Option<timescaledb_toolkit::state_aggregate::StateAgg> */
	"start" TimestampTz, /* timescaledb_toolkit::raw::TimestampTz */
	"interval" Interval, /* timescaledb_toolkit::raw::Interval */
	"prev" StateAgg /* core::option::Option<timescaledb_toolkit::state_aggregate::StateAgg> */
...
CREATE  FUNCTION "hyperloglog_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "hyperloglog_out"(
...
CREATE TYPE HyperLogLog (
	INTERNALLENGTH = variable,
	INPUT = hyperloglog_in, /* timescaledb_toolkit::hyperloglog::hyperloglog_in */
	OUTPUT = hyperloglog_out, /* timescaledb_toolkit::hyperloglog::hyperloglog_out */
	STORAGE = extended
);

-- extension/src/hyperloglog.rs:350
-- timescaledb_toolkit::hyperloglog::distinct_count
CREATE  FUNCTION "distinct_count"(
...
CREATE  FUNCTION "hyperloglog_union"(
	"state" internal, /* pgrx::datum::internal::Internal */
...
CREATE  FUNCTION "hyperloglog_final"(
	"state" internal /* pgrx::datum::internal::Internal */
) RETURNS HyperLogLog /* core::option::Option<timescaledb_toolkit::hyperloglog::HyperLogLog> */
IMMUTABLE PARALLEL SAFE
LANGUAGE c /* Rust */
...
CREATE TYPE CounterSummary;

-- extension/src/counter_agg.rs:39
-- timescaledb_toolkit::counter_agg::countersummary_in
CREATE  FUNCTION "countersummary_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "countersummary_out"(
...
CREATE TYPE CounterSummary (
	INTERNALLENGTH = variable,
	INPUT = countersummary_in, /* timescaledb_toolkit::counter_agg::countersummary_in */
	OUTPUT = countersummary_out, /* timescaledb_toolkit::counter_agg::countersummary_out */
	STORAGE = extended
);
...
CREATE  FUNCTION "counter_zero_time"(
	"summary" CounterSummary /* timescaledb_toolkit::counter_agg::CounterSummary */
...
CREATE  FUNCTION "extrapolated_delta"(
	"summary" CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
	"method" TEXT /* &str */
) RETURNS double precision /* core::option::Option<f64> */
IMMUTABLE STRICT PARALLEL SAFE 
...
CREATE  FUNCTION "counter_agg_summary_trans"(
	"state" internal, /* pgrx::datum::internal::Internal */
...
CREATE  FUNCTION "interpolated_rate"(
	"summary" CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
	"start" TimestampTz, /* timescaledb_toolkit::raw::TimestampTz */
	"duration" Interval, /* timescaledb_toolkit::raw::Interval */
...
CREATE  FUNCTION "counter_agg_final"(
	"state" internal /* pgrx::datum::internal::Internal */
) RETURNS CounterSummary /* core::option::Option<timescaledb_toolkit::counter_agg::CounterSummary> */
IMMUTABLE PARALLEL SAFE
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "interpolated_delta"(
	"summary" CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
	"start" TimestampTz, /* timescaledb_toolkit::raw::TimestampTz */
	"duration" Interval, /* timescaledb_toolkit::raw::Interval */
	"prev" CounterSummary, /* core::option::Option<timescaledb_toolkit::counter_agg::CounterSummary> */
...
CREATE  FUNCTION "extrapolated_rate"(
	"summary" CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
	"method" TEXT /* &str */
) RETURNS double precision /* core::option::Option<f64> */
IMMUTABLE STRICT PARALLEL SAFE 
...
CREATE TYPE AccessorXIntercept;

-- extension/src/accessors.rs:73
-- timescaledb_toolkit::accessors::accessorxintercept_in
CREATE  FUNCTION "accessorxintercept_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorxintercept_out"(
...
CREATE TYPE AccessorXIntercept (
	INTERNALLENGTH = variable,
	INPUT = accessorxintercept_in, /* timescaledb_toolkit::accessors::accessorxintercept_in */
	OUTPUT = accessorxintercept_out, /* timescaledb_toolkit::accessors::accessorxintercept_out */
	STORAGE = extended
);

-- extension/src/stats_agg.rs:1331
-- timescaledb_toolkit::stats_agg::arrow_stats2d_x_intercept
CREATE  FUNCTION "arrow_stats2d_x_intercept"(
...
-- timescaledb_toolkit::stats_agg::arrow_stats2d_x_intercept
CREATE OPERATOR -> (
	PROCEDURE="arrow_stats2d_x_intercept",
	LEFTARG=StatsSummary2D, /* timescaledb_toolkit::stats_agg::StatsSummary2D */
	RIGHTARG=AccessorXIntercept /* timescaledb_toolkit::accessors::AccessorXIntercept */
);

-- extension/src/accessors.rs:73
-- timescaledb_toolkit::accessors::x_intercept
CREATE  FUNCTION "x_intercept"() RETURNS AccessorXIntercept /* timescaledb_toolkit::accessors::AccessorXIntercept */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE TYPE AccessorWithBounds;

-- extension/src/accessors.rs:488
-- timescaledb_toolkit::accessors::accessorwithbounds_in
CREATE  FUNCTION "accessorwithbounds_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorwithbounds_out"(
...
CREATE TYPE AccessorWithBounds (
	INTERNALLENGTH = variable,
	INPUT = accessorwithbounds_in, /* timescaledb_toolkit::accessors::accessorwithbounds_in */
	OUTPUT = accessorwithbounds_out, /* timescaledb_toolkit::accessors::accessorwithbounds_out */
	STORAGE = extended
);
...
CREATE  FUNCTION "arrow_counter_agg_with_bounds"(
	"sketch" CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
...
-- timescaledb_toolkit::counter_agg::arrow_counter_agg_with_bounds
CREATE OPERATOR -> (
	PROCEDURE="arrow_counter_agg_with_bounds",
	LEFTARG=CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
...
CREATE TYPE AccessorVarianceY;

-- extension/src/accessors.rs:254
-- timescaledb_toolkit::accessors::accessorvariancey_in
CREATE  FUNCTION "accessorvariancey_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorvariancey_out"(
...
CREATE TYPE AccessorVarianceY (
	INTERNALLENGTH = variable,
	INPUT = accessorvariancey_in, /* timescaledb_toolkit::accessors::accessorvariancey_in */
	OUTPUT = accessorvariancey_out, /* timescaledb_toolkit::accessors::accessorvariancey_out */
	STORAGE = extended
);
...
CREATE  FUNCTION "arrow_stats2d_variance_y"(
...
-- timescaledb_toolkit::stats_agg::arrow_stats2d_variance_y
CREATE OPERATOR -> (
	PROCEDURE="arrow_stats2d_variance_y",
	LEFTARG=StatsSummary2D, /* core::option::Option<timescaledb_toolkit::stats_agg::StatsSummary2D> */
	RIGHTARG=AccessorVarianceY /* timescaledb_toolkit::accessors::AccessorVarianceY */
);

-- extension/src/accessors.rs:230
-- timescaledb_toolkit::accessors::AccessorVarianceX
CREATE TYPE AccessorVarianceX;

-- extension/src/accessors.rs:230
-- timescaledb_toolkit::accessors::accessorvariancex_in
CREATE  FUNCTION "accessorvariancex_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorvariancex_out"(
...
CREATE TYPE AccessorVarianceX (
	INTERNALLENGTH = variable,
	INPUT = accessorvariancex_in, /* timescaledb_toolkit::accessors::accessorvariancex_in */
	OUTPUT = accessorvariancex_out, /* timescaledb_toolkit::accessors::accessorvariancex_out */
	STORAGE = extended
);
...
CREATE  FUNCTION "arrow_stats2d_variance_x"(
	"sketch" StatsSummary2D, /* core::option::Option<timescaledb_toolkit::stats_agg::StatsSummary2D> */
...
-- timescaledb_toolkit::stats_agg::arrow_stats2d_variance_x
CREATE OPERATOR -> (
	PROCEDURE="arrow_stats2d_variance_x",
	LEFTARG=StatsSummary2D, /* core::option::Option<timescaledb_toolkit::stats_agg::StatsSummary2D> */
	RIGHTARG=AccessorVarianceX /* timescaledb_toolkit::accessors::AccessorVarianceX */
);

-- extension/src/accessors.rs:206
-- timescaledb_toolkit::accessors::AccessorVariance
CREATE TYPE AccessorVariance;

-- extension/src/accessors.rs:206
-- timescaledb_toolkit::accessors::accessorvariance_in
CREATE  FUNCTION "accessorvariance_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorvariance_out"(
...
CREATE TYPE AccessorVariance (
	INTERNALLENGTH = variable,
	INPUT = accessorvariance_in, /* timescaledb_toolkit::accessors::accessorvariance_in */
	OUTPUT = accessorvariance_out, /* timescaledb_toolkit::accessors::accessorvariance_out */
	STORAGE = extended
);

-- extension/src/stats_agg.rs:974
-- timescaledb_toolkit::stats_agg::arrow_stats1d_variance
CREATE  FUNCTION "arrow_stats1d_variance"(
...
-- timescaledb_toolkit::stats_agg::arrow_stats1d_variance
CREATE OPERATOR -> (
	PROCEDURE="arrow_stats1d_variance",
	LEFTARG=StatsSummary1D, /* core::option::Option<timescaledb_toolkit::stats_agg::StatsSummary1D> */
	RIGHTARG=AccessorVariance /* timescaledb_toolkit::accessors::AccessorVariance */
);
...
CREATE TYPE AccessorUnnest;

-- extension/src/accessors.rs:543
-- timescaledb_toolkit::accessors::accessorunnest_in
CREATE  FUNCTION "accessorunnest_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorunnest_out"(
...
CREATE TYPE AccessorUnnest (
	INTERNALLENGTH = variable,
	INPUT = accessorunnest_in, /* timescaledb_toolkit::accessors::accessorunnest_in */
	OUTPUT = accessorunnest_out, /* timescaledb_toolkit::accessors::accessorunnest_out */
	STORAGE = extended
);

-- extension/src/accessors.rs:554
-- timescaledb_toolkit::accessors::unnest
CREATE  FUNCTION "unnest"() RETURNS AccessorUnnest /* timescaledb_toolkit::accessors::AccessorUnnest */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "arrow_timevector_unnest"(
	"series" Timevector_TSTZ_F64, /* timescaledb_toolkit::time_vector::Timevector_TSTZ_F64 */
...
-- timescaledb_toolkit::time_vector::arrow_timevector_unnest
CREATE OPERATOR -> (
	PROCEDURE="arrow_timevector_unnest",
	LEFTARG=Timevector_TSTZ_F64, /* timescaledb_toolkit::time_vector::Timevector_TSTZ_F64 */
	RIGHTARG=AccessorUnnest /* timescaledb_toolkit::accessors::AccessorUnnest */
);
...
CREATE TYPE AccessorTimeDelta;

-- extension/src/accessors.rs:78
-- timescaledb_toolkit::accessors::accessortimedelta_in
CREATE  FUNCTION "accessortimedelta_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessortimedelta_out"(
...
CREATE TYPE AccessorTimeDelta (
	INTERNALLENGTH = variable,
	INPUT = accessortimedelta_in, /* timescaledb_toolkit::accessors::accessortimedelta_in */
	OUTPUT = accessortimedelta_out, /* timescaledb_toolkit::accessors::accessortimedelta_out */
	STORAGE = extended
);

-- extension/src/counter_agg.rs:502
-- timescaledb_toolkit::counter_agg::arrow_counter_agg_time_delta
CREATE  FUNCTION "arrow_counter_agg_time_delta"(
	"sketch" CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
...
-- timescaledb_toolkit::counter_agg::arrow_counter_agg_time_delta
CREATE OPERATOR -> (
	PROCEDURE="arrow_counter_agg_time_delta",
	LEFTARG=CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
...
CREATE  FUNCTION "time_delta"() RETURNS AccessorTimeDelta /* timescaledb_toolkit::accessors::AccessorTimeDelta */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE TYPE AccessorSumY;

-- extension/src/accessors.rs:69
-- timescaledb_toolkit::accessors::accessorsumy_in
CREATE  FUNCTION "accessorsumy_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorsumy_out"(
...
CREATE TYPE AccessorSumY (
	INTERNALLENGTH = variable,
	INPUT = accessorsumy_in, /* timescaledb_toolkit::accessors::accessorsumy_in */
	OUTPUT = accessorsumy_out, /* timescaledb_toolkit::accessors::accessorsumy_out */
	STORAGE = extended
);

-- extension/src/accessors.rs:69
-- timescaledb_toolkit::accessors::sum_y
CREATE  FUNCTION "sum_y"() RETURNS AccessorSumY /* timescaledb_toolkit::accessors::AccessorSumY */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "arrow_stats2d_sum_y"(
	"sketch" StatsSummary2D, /* timescaledb_toolkit::stats_agg::StatsSummary2D */
...
-- timescaledb_toolkit::stats_agg::arrow_stats2d_sum_y
CREATE OPERATOR -> (
	PROCEDURE="arrow_stats2d_sum_y",
	LEFTARG=StatsSummary2D, /* timescaledb_toolkit::stats_agg::StatsSummary2D */
	RIGHTARG=AccessorSumY /* timescaledb_toolkit::accessors::AccessorSumY */
);

-- extension/src/accessors.rs:68
-- timescaledb_toolkit::accessors::AccessorSumX
CREATE TYPE AccessorSumX;

-- extension/src/accessors.rs:68
-- timescaledb_toolkit::accessors::accessorsumx_in
CREATE  FUNCTION "accessorsumx_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorsumx_out"(
...
CREATE TYPE AccessorSumX (
	INTERNALLENGTH = variable,
	INPUT = accessorsumx_in, /* timescaledb_toolkit::accessors::accessorsumx_in */
	OUTPUT = accessorsumx_out, /* timescaledb_toolkit::accessors::accessorsumx_out */
	STORAGE = extended
);

-- extension/src/accessors.rs:68
-- timescaledb_toolkit::accessors::sum_x
CREATE  FUNCTION "sum_x"() RETURNS AccessorSumX /* timescaledb_toolkit::accessors::AccessorSumX */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "arrow_stats2d_sum_x"(
	"sketch" StatsSummary2D, /* timescaledb_toolkit::stats_agg::StatsSummary2D */
...
-- timescaledb_toolkit::stats_agg::arrow_stats2d_sum_x
CREATE OPERATOR -> (
	PROCEDURE="arrow_stats2d_sum_x",
	LEFTARG=StatsSummary2D, /* timescaledb_toolkit::stats_agg::StatsSummary2D */
	RIGHTARG=AccessorSumX /* timescaledb_toolkit::accessors::AccessorSumX */
);

-- extension/src/accessors.rs:67
-- timescaledb_toolkit::accessors::AccessorSum
CREATE TYPE AccessorSum;

-- extension/src/accessors.rs:67
-- timescaledb_toolkit::accessors::accessorsum_in
CREATE  FUNCTION "accessorsum_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorsum_out"(
...
CREATE TYPE AccessorSum (
	INTERNALLENGTH = variable,
	INPUT = accessorsum_in, /* timescaledb_toolkit::accessors::accessorsum_in */
	OUTPUT = accessorsum_out, /* timescaledb_toolkit::accessors::accessorsum_out */
	STORAGE = extended
);

-- extension/src/stats_agg.rs:939
-- timescaledb_toolkit::stats_agg::arrow_stats1d_sum
CREATE  FUNCTION "arrow_stats1d_sum"(
...
-- timescaledb_toolkit::stats_agg::arrow_stats1d_sum
CREATE OPERATOR -> (
	PROCEDURE="arrow_stats1d_sum",
	LEFTARG=StatsSummary1D, /* timescaledb_toolkit::stats_agg::StatsSummary1D */
	RIGHTARG=AccessorSum /* timescaledb_toolkit::accessors::AccessorSum */
);

-- extension/src/accessors.rs:67
-- timescaledb_toolkit::accessors::sum
CREATE  FUNCTION "sum"() RETURNS AccessorSum /* timescaledb_toolkit::accessors::AccessorSum */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE TYPE AccessorStderror;

-- extension/src/accessors.rs:76
-- timescaledb_toolkit::accessors::accessorstderror_in
CREATE  FUNCTION "accessorstderror_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorstderror_out"(
...
CREATE TYPE AccessorStderror (
	INTERNALLENGTH = variable,
	INPUT = accessorstderror_in, /* timescaledb_toolkit::accessors::accessorstderror_in */
	OUTPUT = accessorstderror_out, /* timescaledb_toolkit::accessors::accessorstderror_out */
	STORAGE = extended
);

-- extension/src/hyperloglog.rs:375
-- timescaledb_toolkit::hyperloglog::arrow_hyperloglog_error
CREATE  FUNCTION "arrow_hyperloglog_error"(
...
-- timescaledb_toolkit::hyperloglog::arrow_hyperloglog_error
CREATE OPERATOR -> (
	PROCEDURE="arrow_hyperloglog_error",
	LEFTARG=HyperLogLog, /* timescaledb_toolkit::hyperloglog::HyperLogLog */
	RIGHTARG=AccessorStderror /* timescaledb_toolkit::accessors::AccessorStderror */
);

-- extension/src/accessors.rs:76
-- timescaledb_toolkit::accessors::stderror
CREATE  FUNCTION "stderror"() RETURNS AccessorStderror /* timescaledb_toolkit::accessors::AccessorStderror */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE TYPE AccessorStdDevY;

-- extension/src/accessors.rs:182
-- timescaledb_toolkit::accessors::accessorstddevy_in
CREATE  FUNCTION "accessorstddevy_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorstddevy_out"(
...
CREATE TYPE AccessorStdDevY (
	INTERNALLENGTH = variable,
	INPUT = accessorstddevy_in, /* timescaledb_toolkit::accessors::accessorstddevy_in */
	OUTPUT = accessorstddevy_out, /* timescaledb_toolkit::accessors::accessorstddevy_out */
	STORAGE = extended
);

-- extension/src/stats_agg.rs:1128
-- timescaledb_toolkit::stats_agg::arrow_stats2d_stdddev_y
CREATE  FUNCTION "arrow_stats2d_stdddev_y"(
	"sketch" StatsSummary2D, /* core::option::Option<timescaledb_toolkit::stats_agg::StatsSummary2D> */
...
-- timescaledb_toolkit::stats_agg::arrow_stats2d_stdddev_y
CREATE OPERATOR -> (
	PROCEDURE="arrow_stats2d_stdddev_y",
	LEFTARG=StatsSummary2D, /* core::option::Option<timescaledb_toolkit::stats_agg::StatsSummary2D> */
	RIGHTARG=AccessorStdDevY /* timescaledb_toolkit::accessors::AccessorStdDevY */
);
...
CREATE TYPE AccessorStdDevX;

-- extension/src/accessors.rs:158
-- timescaledb_toolkit::accessors::accessorstddevx_in
CREATE  FUNCTION "accessorstddevx_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorstddevx_out"(
...
CREATE TYPE AccessorStdDevX (
	INTERNALLENGTH = variable,
	INPUT = accessorstddevx_in, /* timescaledb_toolkit::accessors::accessorstddevx_in */
	OUTPUT = accessorstddevx_out, /* timescaledb_toolkit::accessors::accessorstddevx_out */
	STORAGE = extended
);
...
CREATE  FUNCTION "arrow_stats2d_stdddev_x"(
	"sketch" StatsSummary2D, /* core::option::Option<timescaledb_toolkit::stats_agg::StatsSummary2D> */
...
-- timescaledb_toolkit::stats_agg::arrow_stats2d_stdddev_x
CREATE OPERATOR -> (
	PROCEDURE="arrow_stats2d_stdddev_x",
	LEFTARG=StatsSummary2D, /* core::option::Option<timescaledb_toolkit::stats_agg::StatsSummary2D> */
	RIGHTARG=AccessorStdDevX /* timescaledb_toolkit::accessors::AccessorStdDevX */
);

-- extension/src/accessors.rs:134
-- timescaledb_toolkit::accessors::AccessorStdDev
CREATE TYPE AccessorStdDev;

-- extension/src/accessors.rs:134
-- timescaledb_toolkit::accessors::accessorstddev_in
CREATE  FUNCTION "accessorstddev_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorstddev_out"(
...
CREATE TYPE AccessorStdDev (
	INTERNALLENGTH = variable,
	INPUT = accessorstddev_in, /* timescaledb_toolkit::accessors::accessorstddev_in */
	OUTPUT = accessorstddev_out, /* timescaledb_toolkit::accessors::accessorstddev_out */
	STORAGE = extended
);

-- extension/src/stats_agg.rs:953
-- timescaledb_toolkit::stats_agg::arrow_stats1d_stddev
CREATE  FUNCTION "arrow_stats1d_stddev"(
	"sketch" StatsSummary1D, /* core::option::Option<timescaledb_toolkit::stats_agg::StatsSummary1D> */
...
-- timescaledb_toolkit::stats_agg::arrow_stats1d_stddev
CREATE OPERATOR -> (
	PROCEDURE="arrow_stats1d_stddev",
	LEFTARG=StatsSummary1D, /* core::option::Option<timescaledb_toolkit::stats_agg::StatsSummary1D> */
	RIGHTARG=AccessorStdDev /* timescaledb_toolkit::accessors::AccessorStdDev */
);
...
CREATE TYPE AccessorSlope;

-- extension/src/accessors.rs:70
-- timescaledb_toolkit::accessors::accessorslope_in
CREATE  FUNCTION "accessorslope_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorslope_out"(
...
CREATE TYPE AccessorSlope (
	INTERNALLENGTH = variable,
	INPUT = accessorslope_in, /* timescaledb_toolkit::accessors::accessorslope_in */
	OUTPUT = accessorslope_out, /* timescaledb_toolkit::accessors::accessorslope_out */
	STORAGE = extended
);

-- extension/src/stats_agg.rs:1289
-- timescaledb_toolkit::stats_agg::arrow_stats2d_slope
CREATE  FUNCTION "arrow_stats2d_slope"(
	"sketch" StatsSummary2D, /* timescaledb_toolkit::stats_agg::StatsSummary2D */
...
CREATE  FUNCTION "arrow_counter_agg_slope"(
	"sketch" CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
	"_accessor" AccessorSlope /* timescaledb_toolkit::accessors::AccessorSlope */
) RETURNS double precision /* core::option::Option<f64> */
IMMUTABLE STRICT PARALLEL SAFE
...
-- timescaledb_toolkit::counter_agg::arrow_counter_agg_slope
CREATE OPERATOR -> (
	PROCEDURE="arrow_counter_agg_slope",
	LEFTARG=CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
	RIGHTARG=AccessorSlope /* timescaledb_toolkit::accessors::AccessorSlope */
);
...
CREATE  FUNCTION "slope"() RETURNS AccessorSlope /* timescaledb_toolkit::accessors::AccessorSlope */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE TYPE AccessorSkewnessY;

-- extension/src/accessors.rs:324
-- timescaledb_toolkit::accessors::accessorskewnessy_in
CREATE  FUNCTION "accessorskewnessy_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorskewnessy_out"(
...
CREATE TYPE AccessorSkewnessY (
	INTERNALLENGTH = variable,
	INPUT = accessorskewnessy_in, /* timescaledb_toolkit::accessors::accessorskewnessy_in */
	OUTPUT = accessorskewnessy_out, /* timescaledb_toolkit::accessors::accessorskewnessy_out */
	STORAGE = extended
);
...
CREATE  FUNCTION "arrow_stats2d_skewness_y"(
	"sketch" StatsSummary2D, /* timescaledb_toolkit::stats_agg::StatsSummary2D */
...
-- timescaledb_toolkit::stats_agg::arrow_stats2d_skewness_y
CREATE OPERATOR -> (
	PROCEDURE="arrow_stats2d_skewness_y",
	LEFTARG=StatsSummary2D, /* timescaledb_toolkit::stats_agg::StatsSummary2D */
	RIGHTARG=AccessorSkewnessY /* timescaledb_toolkit::accessors::AccessorSkewnessY */
);

-- extension/src/accessors.rs:301
-- timescaledb_toolkit::accessors::AccessorSkewnessX
CREATE TYPE AccessorSkewnessX;

-- extension/src/accessors.rs:301
-- timescaledb_toolkit::accessors::accessorskewnessx_in
CREATE  FUNCTION "accessorskewnessx_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorskewnessx_out"(
...
CREATE TYPE AccessorSkewnessX (
	INTERNALLENGTH = variable,
	INPUT = accessorskewnessx_in, /* timescaledb_toolkit::accessors::accessorskewnessx_in */
	OUTPUT = accessorskewnessx_out, /* timescaledb_toolkit::accessors::accessorskewnessx_out */
	STORAGE = extended
);

-- extension/src/stats_agg.rs:1191
-- timescaledb_toolkit::stats_agg::arrow_stats2d_skewness_x
CREATE  FUNCTION "arrow_stats2d_skewness_x"(
	"sketch" StatsSummary2D, /* timescaledb_toolkit::stats_agg::StatsSummary2D */
...
-- timescaledb_toolkit::stats_agg::arrow_stats2d_skewness_x
CREATE OPERATOR -> (
	PROCEDURE="arrow_stats2d_skewness_x",
	LEFTARG=StatsSummary2D, /* timescaledb_toolkit::stats_agg::StatsSummary2D */
	RIGHTARG=AccessorSkewnessX /* timescaledb_toolkit::accessors::AccessorSkewnessX */
);
...
CREATE TYPE AccessorSkewness;

-- extension/src/accessors.rs:278
-- timescaledb_toolkit::accessors::accessorskewness_in
CREATE  FUNCTION "accessorskewness_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorskewness_out"(
...
CREATE TYPE AccessorSkewness (
	INTERNALLENGTH = variable,
	INPUT = accessorskewness_in, /* timescaledb_toolkit::accessors::accessorskewness_in */
	OUTPUT = accessorskewness_out, /* timescaledb_toolkit::accessors::accessorskewness_out */
	STORAGE = extended
);

-- extension/src/stats_agg.rs:995
-- timescaledb_toolkit::stats_agg::arrow_stats1d_skewness
CREATE  FUNCTION "arrow_stats1d_skewness"(
	"sketch" StatsSummary1D, /* timescaledb_toolkit::stats_agg::StatsSummary1D */
...
-- timescaledb_toolkit::stats_agg::arrow_stats1d_skewness
CREATE OPERATOR -> (
	PROCEDURE="arrow_stats1d_skewness",
	LEFTARG=StatsSummary1D, /* timescaledb_toolkit::stats_agg::StatsSummary1D */
	RIGHTARG=AccessorSkewness /* timescaledb_toolkit::accessors::AccessorSkewness */
);
...
CREATE TYPE AccessorRate;

-- extension/src/accessors.rs:79
-- timescaledb_toolkit::accessors::accessorrate_in
CREATE  FUNCTION "accessorrate_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorrate_out"(
...
CREATE TYPE AccessorRate (
	INTERNALLENGTH = variable,
	INPUT = accessorrate_in, /* timescaledb_toolkit::accessors::accessorrate_in */
	OUTPUT = accessorrate_out, /* timescaledb_toolkit::accessors::accessorrate_out */
	STORAGE = extended
);

-- extension/src/accessors.rs:79
-- timescaledb_toolkit::accessors::rate
CREATE  FUNCTION "rate"() RETURNS AccessorRate /* timescaledb_toolkit::accessors::AccessorRate */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "arrow_counter_agg_rate"(
	"sketch" CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
...
-- timescaledb_toolkit::counter_agg::arrow_counter_agg_rate
CREATE OPERATOR -> (
	PROCEDURE="arrow_counter_agg_rate",
	LEFTARG=CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
...
CREATE  FUNCTION "approx_percentiles"(
...
CREATE TYPE AccessorNumVals;

-- extension/src/accessors.rs:59
-- timescaledb_toolkit::accessors::accessornumvals_in
CREATE  FUNCTION "accessornumvals_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessornumvals_out"(
...
CREATE TYPE AccessorNumVals (
	INTERNALLENGTH = variable,
	INPUT = accessornumvals_in, /* timescaledb_toolkit::accessors::accessornumvals_in */
	OUTPUT = accessornumvals_out, /* timescaledb_toolkit::accessors::accessornumvals_out */
	STORAGE = extended
);

-- extension/src/accessors.rs:59
-- timescaledb_toolkit::accessors::num_vals
CREATE  FUNCTION "num_vals"() RETURNS AccessorNumVals /* timescaledb_toolkit::accessors::AccessorNumVals */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "arrow_stats2d_num_vals"(
	"sketch" StatsSummary2D, /* timescaledb_toolkit::stats_agg::StatsSummary2D */
...
-- timescaledb_toolkit::stats_agg::arrow_stats2d_num_vals
CREATE OPERATOR -> (
	PROCEDURE="arrow_stats2d_num_vals",
	LEFTARG=StatsSummary2D, /* timescaledb_toolkit::stats_agg::StatsSummary2D */
	RIGHTARG=AccessorNumVals /* timescaledb_toolkit::accessors::AccessorNumVals */
);

-- extension/src/uddsketch.rs:641
-- timescaledb_toolkit::uddsketch::arrow_uddsketch_num_vals
CREATE  FUNCTION "arrow_uddsketch_num_vals"(
	"sketch" UddSketch, /* timescaledb_toolkit::uddsketch::UddSketch */
	"_accessor" AccessorNumVals /* timescaledb_toolkit::accessors::AccessorNumVals */
) RETURNS double precision /* f64 */
IMMUTABLE STRICT PARALLEL SAFE
...
-- timescaledb_toolkit::uddsketch::arrow_uddsketch_num_vals
CREATE OPERATOR -> (
	PROCEDURE="arrow_uddsketch_num_vals",
	LEFTARG=UddSketch, /* timescaledb_toolkit::uddsketch::UddSketch */
	RIGHTARG=AccessorNumVals /* timescaledb_toolkit::accessors::AccessorNumVals */
);
...
CREATE  FUNCTION "arrow_stats1d_num_vals"(
	"sketch" StatsSummary1D, /* timescaledb_toolkit::stats_agg::StatsSummary1D */
	"_accessor" AccessorNumVals /* timescaledb_toolkit::accessors::AccessorNumVals */
) RETURNS bigint /* i64 */
IMMUTABLE STRICT PARALLEL SAFE
...
-- timescaledb_toolkit::stats_agg::arrow_stats1d_num_vals
CREATE OPERATOR -> (
	PROCEDURE="arrow_stats1d_num_vals",
	LEFTARG=StatsSummary1D, /* timescaledb_toolkit::stats_agg::StatsSummary1D */
	RIGHTARG=AccessorNumVals /* timescaledb_toolkit::accessors::AccessorNumVals */
);
...
CREATE  FUNCTION "arrow_tdigest_num_vals"(
...
-- timescaledb_toolkit::tdigest::arrow_tdigest_num_vals
CREATE OPERATOR -> (
	PROCEDURE="arrow_tdigest_num_vals",
	LEFTARG=TDigest, /* timescaledb_toolkit::tdigest::TDigest */
	RIGHTARG=AccessorNumVals /* timescaledb_toolkit::accessors::AccessorNumVals */
);

-- extension/src/accessors.rs:86
-- timescaledb_toolkit::accessors::AccessorNumResets
CREATE TYPE AccessorNumResets;

-- extension/src/accessors.rs:86
-- timescaledb_toolkit::accessors::accessornumresets_in
CREATE  FUNCTION "accessornumresets_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessornumresets_out"(
...
CREATE TYPE AccessorNumResets (
	INTERNALLENGTH = variable,
	INPUT = accessornumresets_in, /* timescaledb_toolkit::accessors::accessornumresets_in */
	OUTPUT = accessornumresets_out, /* timescaledb_toolkit::accessors::accessornumresets_out */
	STORAGE = extended
);

-- extension/src/counter_agg.rs:758
-- timescaledb_toolkit::counter_agg::arrow_counter_agg_num_resets
CREATE  FUNCTION "arrow_counter_agg_num_resets"(
	"sketch" CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
...
-- timescaledb_toolkit::counter_agg::arrow_counter_agg_num_resets
CREATE OPERATOR -> (
	PROCEDURE="arrow_counter_agg_num_resets",
	LEFTARG=CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
	RIGHTARG=AccessorNumResets /* timescaledb_toolkit::accessors::AccessorNumResets */
);

-- extension/src/accessors.rs:86
-- timescaledb_toolkit::accessors::num_resets
CREATE  FUNCTION "num_resets"() RETURNS AccessorNumResets /* timescaledb_toolkit::accessors::AccessorNumResets */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE TYPE AccessorNumElements;

-- extension/src/accessors.rs:84
-- timescaledb_toolkit::accessors::accessornumelements_in
CREATE  FUNCTION "accessornumelements_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessornumelements_out"(
...
CREATE TYPE AccessorNumElements (
	INTERNALLENGTH = variable,
	INPUT = accessornumelements_in, /* timescaledb_toolkit::accessors::accessornumelements_in */
	OUTPUT = accessornumelements_out, /* timescaledb_toolkit::accessors::accessornumelements_out */
	STORAGE = extended
);

-- extension/src/counter_agg.rs:730
-- timescaledb_toolkit::counter_agg::arrow_counter_agg_num_elements
CREATE  FUNCTION "arrow_counter_agg_num_elements"(
	"sketch" CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
...
-- timescaledb_toolkit::counter_agg::arrow_counter_agg_num_elements
CREATE OPERATOR -> (
	PROCEDURE="arrow_counter_agg_num_elements",
	LEFTARG=CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
...
CREATE  FUNCTION "num_elements"() RETURNS AccessorNumElements /* timescaledb_toolkit::accessors::AccessorNumElements */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE TYPE AccessorNumChanges;

-- extension/src/accessors.rs:85
-- timescaledb_toolkit::accessors::accessornumchanges_in
CREATE  FUNCTION "accessornumchanges_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessornumchanges_out"(
...
CREATE TYPE AccessorNumChanges (
	INTERNALLENGTH = variable,
	INPUT = accessornumchanges_in, /* timescaledb_toolkit::accessors::accessornumchanges_in */
	OUTPUT = accessornumchanges_out, /* timescaledb_toolkit::accessors::accessornumchanges_out */
	STORAGE = extended
);

-- extension/src/counter_agg.rs:744
-- timescaledb_toolkit::counter_agg::arrow_counter_agg_num_changes
CREATE  FUNCTION "arrow_counter_agg_num_changes"(
	"sketch" CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
...
-- timescaledb_toolkit::counter_agg::arrow_counter_agg_num_changes
CREATE OPERATOR -> (
	PROCEDURE="arrow_counter_agg_num_changes",
	LEFTARG=CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
...
CREATE  FUNCTION "num_changes"() RETURNS AccessorNumChanges /* timescaledb_toolkit::accessors::AccessorNumChanges */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE TYPE AccessorMinVal;

-- extension/src/accessors.rs:62
-- timescaledb_toolkit::accessors::accessorminval_in
CREATE  FUNCTION "accessorminval_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorminval_out"(
...
CREATE TYPE AccessorMinVal (
	INTERNALLENGTH = variable,
	INPUT = accessorminval_in, /* timescaledb_toolkit::accessors::accessorminval_in */
	OUTPUT = accessorminval_out, /* timescaledb_toolkit::accessors::accessorminval_out */
	STORAGE = extended
);

-- extension/src/tdigest.rs:380
-- timescaledb_toolkit::tdigest::arrow_tdigest_min
CREATE  FUNCTION "arrow_tdigest_min"(
	"sketch" TDigest, /* timescaledb_toolkit::tdigest::TDigest */
...
-- timescaledb_toolkit::tdigest::arrow_tdigest_min
CREATE OPERATOR -> (
	PROCEDURE="arrow_tdigest_min",
	LEFTARG=TDigest, /* timescaledb_toolkit::tdigest::TDigest */
	RIGHTARG=AccessorMinVal /* timescaledb_toolkit::accessors::AccessorMinVal */
);

-- extension/src/accessors.rs:62
-- timescaledb_toolkit::accessors::min_val
CREATE  FUNCTION "min_val"() RETURNS AccessorMinVal /* timescaledb_toolkit::accessors::AccessorMinVal */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE TYPE AccessorMean;

-- extension/src/accessors.rs:60
-- timescaledb_toolkit::accessors::accessormean_in
CREATE  FUNCTION "accessormean_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessormean_out"(
...
CREATE TYPE AccessorMean (
	INTERNALLENGTH = variable,
	INPUT = accessormean_in, /* timescaledb_toolkit::accessors::accessormean_in */
	OUTPUT = accessormean_out, /* timescaledb_toolkit::accessors::accessormean_out */
	STORAGE = extended
);

-- extension/src/tdigest.rs:404
-- timescaledb_toolkit::tdigest::arrow_tdigest_mean
CREATE  FUNCTION "arrow_tdigest_mean"(
	"sketch" TDigest, /* timescaledb_toolkit::tdigest::TDigest */
...
-- timescaledb_toolkit::tdigest::arrow_tdigest_mean
CREATE OPERATOR -> (
	PROCEDURE="arrow_tdigest_mean",
	LEFTARG=TDigest, /* timescaledb_toolkit::tdigest::TDigest */
	RIGHTARG=AccessorMean /* timescaledb_toolkit::accessors::AccessorMean */
);

-- extension/src/accessors.rs:60
-- timescaledb_toolkit::accessors::mean
CREATE  FUNCTION "mean"() RETURNS AccessorMean /* timescaledb_toolkit::accessors::AccessorMean */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "arrow_uddsketch_mean"(
	"sketch" UddSketch, /* timescaledb_toolkit::uddsketch::UddSketch */
	"_accessor" AccessorMean /* timescaledb_toolkit::accessors::AccessorMean */
) RETURNS double precision /* f64 */
IMMUTABLE STRICT PARALLEL SAFE
...
-- timescaledb_toolkit::uddsketch::arrow_uddsketch_mean
CREATE OPERATOR -> (
	PROCEDURE="arrow_uddsketch_mean",
	LEFTARG=UddSketch, /* timescaledb_toolkit::uddsketch::UddSketch */
	RIGHTARG=AccessorMean /* timescaledb_toolkit::accessors::AccessorMean */
);
...
CREATE TYPE AccessorMaxVal;

-- extension/src/accessors.rs:63
-- timescaledb_toolkit::accessors::accessormaxval_in
CREATE  FUNCTION "accessormaxval_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessormaxval_out"(
...
CREATE TYPE AccessorMaxVal (
	INTERNALLENGTH = variable,
	INPUT = accessormaxval_in, /* timescaledb_toolkit::accessors::accessormaxval_in */
	OUTPUT = accessormaxval_out, /* timescaledb_toolkit::accessors::accessormaxval_out */
	STORAGE = extended
);

-- extension/src/accessors.rs:63
-- timescaledb_toolkit::accessors::max_val
CREATE  FUNCTION "max_val"() RETURNS AccessorMaxVal /* timescaledb_toolkit::accessors::AccessorMaxVal */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "arrow_tdigest_max"(
	"sketch" TDigest, /* timescaledb_toolkit::tdigest::TDigest */
...
-- timescaledb_toolkit::tdigest::arrow_tdigest_max
CREATE OPERATOR -> (
	PROCEDURE="arrow_tdigest_max",
	LEFTARG=TDigest, /* timescaledb_toolkit::tdigest::TDigest */
	RIGHTARG=AccessorMaxVal /* timescaledb_toolkit::accessors::AccessorMaxVal */
);
...
CREATE TYPE AccessorKurtosisY;

-- extension/src/accessors.rs:393
-- timescaledb_toolkit::accessors::accessorkurtosisy_in
CREATE  FUNCTION "accessorkurtosisy_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorkurtosisy_out"(
...
CREATE TYPE AccessorKurtosisY (
	INTERNALLENGTH = variable,
	INPUT = accessorkurtosisy_in, /* timescaledb_toolkit::accessors::accessorkurtosisy_in */
	OUTPUT = accessorkurtosisy_out, /* timescaledb_toolkit::accessors::accessorkurtosisy_out */
	STORAGE = extended
);

-- extension/src/stats_agg.rs:1254
-- timescaledb_toolkit::stats_agg::arrow_stats2d_kurtosis_y
CREATE  FUNCTION "arrow_stats2d_kurtosis_y"(
	"sketch" StatsSummary2D, /* timescaledb_toolkit::stats_agg::StatsSummary2D */
...
-- timescaledb_toolkit::stats_agg::arrow_stats2d_kurtosis_y
CREATE OPERATOR -> (
	PROCEDURE="arrow_stats2d_kurtosis_y",
	LEFTARG=StatsSummary2D, /* timescaledb_toolkit::stats_agg::StatsSummary2D */
	RIGHTARG=AccessorKurtosisY /* timescaledb_toolkit::accessors::AccessorKurtosisY */
);
...
CREATE TYPE AccessorKurtosisX;

-- extension/src/accessors.rs:370
-- timescaledb_toolkit::accessors::accessorkurtosisx_in
CREATE  FUNCTION "accessorkurtosisx_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorkurtosisx_out"(
...
CREATE TYPE AccessorKurtosisX (
	INTERNALLENGTH = variable,
	INPUT = accessorkurtosisx_in, /* timescaledb_toolkit::accessors::accessorkurtosisx_in */
	OUTPUT = accessorkurtosisx_out, /* timescaledb_toolkit::accessors::accessorkurtosisx_out */
	STORAGE = extended
);

-- extension/src/stats_agg.rs:1233
-- timescaledb_toolkit::stats_agg::arrow_stats2d_kurtosis_x
CREATE  FUNCTION "arrow_stats2d_kurtosis_x"(
	"sketch" StatsSummary2D, /* timescaledb_toolkit::stats_agg::StatsSummary2D */
...
-- timescaledb_toolkit::stats_agg::arrow_stats2d_kurtosis_x
CREATE OPERATOR -> (
	PROCEDURE="arrow_stats2d_kurtosis_x",
	LEFTARG=StatsSummary2D, /* timescaledb_toolkit::stats_agg::StatsSummary2D */
	RIGHTARG=AccessorKurtosisX /* timescaledb_toolkit::accessors::AccessorKurtosisX */
);
...
CREATE TYPE AccessorKurtosis;

-- extension/src/accessors.rs:347
-- timescaledb_toolkit::accessors::accessorkurtosis_in
CREATE  FUNCTION "accessorkurtosis_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorkurtosis_out"(
...
CREATE TYPE AccessorKurtosis (
	INTERNALLENGTH = variable,
	INPUT = accessorkurtosis_in, /* timescaledb_toolkit::accessors::accessorkurtosis_in */
	OUTPUT = accessorkurtosis_out, /* timescaledb_toolkit::accessors::accessorkurtosis_out */
	STORAGE = extended
);
...
CREATE  FUNCTION "arrow_stats1d_kurtosis"(
	"sketch" StatsSummary1D, /* timescaledb_toolkit::stats_agg::StatsSummary1D */
...
-- timescaledb_toolkit::stats_agg::arrow_stats1d_kurtosis
CREATE OPERATOR -> (
	PROCEDURE="arrow_stats1d_kurtosis",
	LEFTARG=StatsSummary1D, /* timescaledb_toolkit::stats_agg::StatsSummary1D */
	RIGHTARG=AccessorKurtosis /* timescaledb_toolkit::accessors::AccessorKurtosis */
);

-- extension/src/accessors.rs:81
-- timescaledb_toolkit::accessors::AccessorIrateRight
CREATE TYPE AccessorIrateRight;

-- extension/src/accessors.rs:81
-- timescaledb_toolkit::accessors::accessorirateright_in
CREATE  FUNCTION "accessorirateright_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorirateright_out"(
...
CREATE TYPE AccessorIrateRight (
	INTERNALLENGTH = variable,
	INPUT = accessorirateright_in, /* timescaledb_toolkit::accessors::accessorirateright_in */
	OUTPUT = accessorirateright_out, /* timescaledb_toolkit::accessors::accessorirateright_out */
	STORAGE = extended
);

-- extension/src/counter_agg.rs:530
-- timescaledb_toolkit::counter_agg::arrow_counter_agg_irate_right
CREATE  FUNCTION "arrow_counter_agg_irate_right"(
	"sketch" CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
...
-- timescaledb_toolkit::counter_agg::arrow_counter_agg_irate_right
CREATE OPERATOR -> (
	PROCEDURE="arrow_counter_agg_irate_right",
	LEFTARG=CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
...
CREATE  FUNCTION "irate_right"() RETURNS AccessorIrateRight /* timescaledb_toolkit::accessors::AccessorIrateRight */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE TYPE AccessorIrateLeft;

-- extension/src/accessors.rs:80
-- timescaledb_toolkit::accessors::accessorirateleft_in
CREATE  FUNCTION "accessorirateleft_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorirateleft_out"(
...
CREATE TYPE AccessorIrateLeft (
	INTERNALLENGTH = variable,
	INPUT = accessorirateleft_in, /* timescaledb_toolkit::accessors::accessorirateleft_in */
	OUTPUT = accessorirateleft_out, /* timescaledb_toolkit::accessors::accessorirateleft_out */
	STORAGE = extended
);

-- extension/src/accessors.rs:80
-- timescaledb_toolkit::accessors::irate_left
CREATE  FUNCTION "irate_left"() RETURNS AccessorIrateLeft /* timescaledb_toolkit::accessors::AccessorIrateLeft */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "arrow_counter_agg_irate_left"(
	"sketch" CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
...
-- timescaledb_toolkit::counter_agg::arrow_counter_agg_irate_left
CREATE OPERATOR -> (
	PROCEDURE="arrow_counter_agg_irate_left",
	LEFTARG=CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
...
CREATE TYPE AccessorIntercept;

-- extension/src/accessors.rs:72
-- timescaledb_toolkit::accessors::accessorintercept_in
CREATE  FUNCTION "accessorintercept_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorintercept_out"(
...
CREATE TYPE AccessorIntercept (
	INTERNALLENGTH = variable,
	INPUT = accessorintercept_in, /* timescaledb_toolkit::accessors::accessorintercept_in */
	OUTPUT = accessorintercept_out, /* timescaledb_toolkit::accessors::accessorintercept_out */
	STORAGE = extended
);

-- extension/src/accessors.rs:72
-- timescaledb_toolkit::accessors::intercept
CREATE  FUNCTION "intercept"() RETURNS AccessorIntercept /* timescaledb_toolkit::accessors::AccessorIntercept */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "arrow_stats2d_intercept"(
	"sketch" StatsSummary2D, /* timescaledb_toolkit::stats_agg::StatsSummary2D */
...
-- timescaledb_toolkit::stats_agg::arrow_stats2d_intercept
CREATE OPERATOR -> (
	PROCEDURE="arrow_stats2d_intercept",
	LEFTARG=StatsSummary2D, /* timescaledb_toolkit::stats_agg::StatsSummary2D */
...
CREATE  FUNCTION "arrow_counter_agg_intercept"(
	"sketch" CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
	"_accessor" AccessorIntercept /* timescaledb_toolkit::accessors::AccessorIntercept */
) RETURNS double precision /* core::option::Option<f64> */
IMMUTABLE STRICT PARALLEL SAFE
...
-- timescaledb_toolkit::counter_agg::arrow_counter_agg_intercept
CREATE OPERATOR -> (
	PROCEDURE="arrow_counter_agg_intercept",
	LEFTARG=CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
	RIGHTARG=AccessorIntercept /* timescaledb_toolkit::accessors::AccessorIntercept */
);
...
CREATE TYPE AccessorIdeltaRight;

-- extension/src/accessors.rs:83
-- timescaledb_toolkit::accessors::accessorideltaright_in
CREATE  FUNCTION "accessorideltaright_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorideltaright_out"(
...
CREATE TYPE AccessorIdeltaRight (
	INTERNALLENGTH = variable,
	INPUT = accessorideltaright_in, /* timescaledb_toolkit::accessors::accessorideltaright_in */
	OUTPUT = accessorideltaright_out, /* timescaledb_toolkit::accessors::accessorideltaright_out */
	STORAGE = extended
);

-- extension/src/counter_agg.rs:558
-- timescaledb_toolkit::counter_agg::arrow_counter_agg_idelta_right
CREATE  FUNCTION "arrow_counter_agg_idelta_right"(
	"sketch" CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
...
-- timescaledb_toolkit::counter_agg::arrow_counter_agg_idelta_right
CREATE OPERATOR -> (
	PROCEDURE="arrow_counter_agg_idelta_right",
	LEFTARG=CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
...
CREATE  FUNCTION "idelta_right"() RETURNS AccessorIdeltaRight /* timescaledb_toolkit::accessors::AccessorIdeltaRight */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE TYPE AccessorIdeltaLeft;

-- extension/src/accessors.rs:82
-- timescaledb_toolkit::accessors::accessorideltaleft_in
CREATE  FUNCTION "accessorideltaleft_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorideltaleft_out"(
...
CREATE TYPE AccessorIdeltaLeft (
	INTERNALLENGTH = variable,
	INPUT = accessorideltaleft_in, /* timescaledb_toolkit::accessors::accessorideltaleft_in */
	OUTPUT = accessorideltaleft_out, /* timescaledb_toolkit::accessors::accessorideltaleft_out */
	STORAGE = extended
);

-- extension/src/counter_agg.rs:544
-- timescaledb_toolkit::counter_agg::arrow_counter_agg_idelta_left
CREATE  FUNCTION "arrow_counter_agg_idelta_left"(
	"sketch" CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
...
-- timescaledb_toolkit::counter_agg::arrow_counter_agg_idelta_left
CREATE OPERATOR -> (
	PROCEDURE="arrow_counter_agg_idelta_left",
	LEFTARG=CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
...
CREATE  FUNCTION "idelta_left"() RETURNS AccessorIdeltaLeft /* timescaledb_toolkit::accessors::AccessorIdeltaLeft */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE TYPE AccessorExtrapolatedRate;

-- extension/src/accessors.rs:464
-- timescaledb_toolkit::accessors::accessorextrapolatedrate_in
CREATE  FUNCTION "accessorextrapolatedrate_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorextrapolatedrate_out"(
...
CREATE TYPE AccessorExtrapolatedRate (
	INTERNALLENGTH = variable,
	INPUT = accessorextrapolatedrate_in, /* timescaledb_toolkit::accessors::accessorextrapolatedrate_in */
	OUTPUT = accessorextrapolatedrate_out, /* timescaledb_toolkit::accessors::accessorextrapolatedrate_out */
	STORAGE = extended
);
...
CREATE  FUNCTION "arrow_counter_agg_extrapolated_rate"(
	"sketch" CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
...
-- timescaledb_toolkit::counter_agg::arrow_counter_agg_extrapolated_rate
CREATE OPERATOR -> (
	PROCEDURE="arrow_counter_agg_extrapolated_rate",
	LEFTARG=CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
...
CREATE TYPE AccessorExtrapolatedDelta;

-- extension/src/accessors.rs:440
-- timescaledb_toolkit::accessors::accessorextrapolateddelta_in
CREATE  FUNCTION "accessorextrapolateddelta_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorextrapolateddelta_out"(
...
CREATE TYPE AccessorExtrapolatedDelta (
	INTERNALLENGTH = variable,
	INPUT = accessorextrapolateddelta_in, /* timescaledb_toolkit::accessors::accessorextrapolateddelta_in */
	OUTPUT = accessorextrapolateddelta_out, /* timescaledb_toolkit::accessors::accessorextrapolateddelta_out */
	STORAGE = extended
);
...
CREATE  FUNCTION "arrow_counter_agg_extrapolated_delta"(
	"sketch" CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
...
-- timescaledb_toolkit::counter_agg::arrow_counter_agg_extrapolated_delta
CREATE OPERATOR -> (
	PROCEDURE="arrow_counter_agg_extrapolated_delta",
	LEFTARG=CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
...
CREATE TYPE AccessorError;

-- extension/src/accessors.rs:61
-- timescaledb_toolkit::accessors::accessorerror_in
CREATE  FUNCTION "accessorerror_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorerror_out"(
...
CREATE TYPE AccessorError (
	INTERNALLENGTH = variable,
	INPUT = accessorerror_in, /* timescaledb_toolkit::accessors::accessorerror_in */
	OUTPUT = accessorerror_out, /* timescaledb_toolkit::accessors::accessorerror_out */
	STORAGE = extended
);

-- extension/src/uddsketch.rs:670
-- timescaledb_toolkit::uddsketch::arrow_uddsketch_error
CREATE  FUNCTION "arrow_uddsketch_error"(
	"sketch" UddSketch, /* timescaledb_toolkit::uddsketch::UddSketch */
...
-- timescaledb_toolkit::uddsketch::arrow_uddsketch_error
CREATE OPERATOR -> (
	PROCEDURE="arrow_uddsketch_error",
	LEFTARG=UddSketch, /* timescaledb_toolkit::uddsketch::UddSketch */
	RIGHTARG=AccessorError /* timescaledb_toolkit::accessors::AccessorError */
);

-- extension/src/accessors.rs:61
-- timescaledb_toolkit::accessors::error
CREATE  FUNCTION "error"() RETURNS AccessorError /* timescaledb_toolkit::accessors::AccessorError */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE TYPE AccessorDistinctCount;

-- extension/src/accessors.rs:75
-- timescaledb_toolkit::accessors::accessordistinctcount_in
CREATE  FUNCTION "accessordistinctcount_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessordistinctcount_out"(
...
CREATE TYPE AccessorDistinctCount (
	INTERNALLENGTH = variable,
	INPUT = accessordistinctcount_in, /* timescaledb_toolkit::accessors::accessordistinctcount_in */
	OUTPUT = accessordistinctcount_out, /* timescaledb_toolkit::accessors::accessordistinctcount_out */
	STORAGE = extended
);

-- extension/src/hyperloglog.rs:342
-- timescaledb_toolkit::hyperloglog::arrow_hyperloglog_count
CREATE  FUNCTION "arrow_hyperloglog_count"(
	"sketch" HyperLogLog, /* timescaledb_toolkit::hyperloglog::HyperLogLog */
...
-- timescaledb_toolkit::hyperloglog::arrow_hyperloglog_count
CREATE OPERATOR -> (
	PROCEDURE="arrow_hyperloglog_count",
	LEFTARG=HyperLogLog, /* timescaledb_toolkit::hyperloglog::HyperLogLog */
	RIGHTARG=AccessorDistinctCount /* timescaledb_toolkit::accessors::AccessorDistinctCount */
);

-- extension/src/accessors.rs:75
-- timescaledb_toolkit::accessors::distinct_count
CREATE  FUNCTION "distinct_count"() RETURNS AccessorDistinctCount /* timescaledb_toolkit::accessors::AccessorDistinctCount */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE TYPE AccessorDeterminationCoeff;

-- extension/src/accessors.rs:74
-- timescaledb_toolkit::accessors::accessordeterminationcoeff_in
CREATE  FUNCTION "accessordeterminationcoeff_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessordeterminationcoeff_out"(
...
CREATE TYPE AccessorDeterminationCoeff (
	INTERNALLENGTH = variable,
	INPUT = accessordeterminationcoeff_in, /* timescaledb_toolkit::accessors::accessordeterminationcoeff_in */
	OUTPUT = accessordeterminationcoeff_out, /* timescaledb_toolkit::accessors::accessordeterminationcoeff_out */
	STORAGE = extended
);

-- extension/src/stats_agg.rs:1345
-- timescaledb_toolkit::stats_agg::arrow_stats2d_determination_coeff
CREATE  FUNCTION "arrow_stats2d_determination_coeff"(
	"sketch" StatsSummary2D, /* timescaledb_toolkit::stats_agg::StatsSummary2D */
...
-- timescaledb_toolkit::stats_agg::arrow_stats2d_determination_coeff
CREATE OPERATOR -> (
	PROCEDURE="arrow_stats2d_determination_coeff",
	LEFTARG=StatsSummary2D, /* timescaledb_toolkit::stats_agg::StatsSummary2D */
	RIGHTARG=AccessorDeterminationCoeff /* timescaledb_toolkit::accessors::AccessorDeterminationCoeff */
);

-- extension/src/accessors.rs:74
-- timescaledb_toolkit::accessors::determination_coeff
CREATE  FUNCTION "determination_coeff"() RETURNS AccessorDeterminationCoeff /* timescaledb_toolkit::accessors::AccessorDeterminationCoeff */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE TYPE AccessorDelta;

-- extension/src/accessors.rs:77
-- timescaledb_toolkit::accessors::accessordelta_in
CREATE  FUNCTION "accessordelta_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessordelta_out"(
...
CREATE TYPE AccessorDelta (
	INTERNALLENGTH = variable,
	INPUT = accessordelta_in, /* timescaledb_toolkit::accessors::accessordelta_in */
	OUTPUT = accessordelta_out, /* timescaledb_toolkit::accessors::accessordelta_out */
	STORAGE = extended
);

-- extension/src/counter_agg.rs:474
-- timescaledb_toolkit::counter_agg::arrow_counter_agg_delta
CREATE  FUNCTION "arrow_counter_agg_delta"(
	"sketch" CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
...
-- timescaledb_toolkit::counter_agg::arrow_counter_agg_delta
CREATE OPERATOR -> (
	PROCEDURE="arrow_counter_agg_delta",
	LEFTARG=CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
...
CREATE  FUNCTION "delta"() RETURNS AccessorDelta /* timescaledb_toolkit::accessors::AccessorDelta */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE TYPE AccessorCovar;

-- extension/src/accessors.rs:416
-- timescaledb_toolkit::accessors::accessorcovar_in
CREATE  FUNCTION "accessorcovar_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorcovar_out"(
...
CREATE TYPE AccessorCovar (
	INTERNALLENGTH = variable,
	INPUT = accessorcovar_in, /* timescaledb_toolkit::accessors::accessorcovar_in */
	OUTPUT = accessorcovar_out, /* timescaledb_toolkit::accessors::accessorcovar_out */
	STORAGE = extended
);

-- extension/src/stats_agg.rs:1359
-- timescaledb_toolkit::stats_agg::arrow_stats2d_covar
CREATE  FUNCTION "arrow_stats2d_covar"(
	"sketch" StatsSummary2D, /* core::option::Option<timescaledb_toolkit::stats_agg::StatsSummary2D> */
...
-- timescaledb_toolkit::stats_agg::arrow_stats2d_covar
CREATE OPERATOR -> (
	PROCEDURE="arrow_stats2d_covar",
	LEFTARG=StatsSummary2D, /* core::option::Option<timescaledb_toolkit::stats_agg::StatsSummary2D> */
	RIGHTARG=AccessorCovar /* timescaledb_toolkit::accessors::AccessorCovar */
);
...
CREATE TYPE AccessorCounterZeroTime;

-- extension/src/accessors.rs:87
-- timescaledb_toolkit::accessors::accessorcounterzerotime_in
CREATE  FUNCTION "accessorcounterzerotime_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorcounterzerotime_out"(
...
CREATE TYPE AccessorCounterZeroTime (
	INTERNALLENGTH = variable,
	INPUT = accessorcounterzerotime_in, /* timescaledb_toolkit::accessors::accessorcounterzerotime_in */
	OUTPUT = accessorcounterzerotime_out, /* timescaledb_toolkit::accessors::accessorcounterzerotime_out */
	STORAGE = extended
);

-- extension/src/accessors.rs:87
-- timescaledb_toolkit::accessors::counter_zero_time
CREATE  FUNCTION "counter_zero_time"() RETURNS AccessorCounterZeroTime /* timescaledb_toolkit::accessors::AccessorCounterZeroTime */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "arrow_counter_agg_zero_time"(
	"sketch" CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
...
-- timescaledb_toolkit::counter_agg::arrow_counter_agg_zero_time
CREATE OPERATOR -> (
	PROCEDURE="arrow_counter_agg_zero_time",
	LEFTARG=CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
...
CREATE TYPE AccessorCorr;

-- extension/src/accessors.rs:71
-- timescaledb_toolkit::accessors::accessorcorr_in
CREATE  FUNCTION "accessorcorr_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorcorr_out"(
...
CREATE TYPE AccessorCorr (
	INTERNALLENGTH = variable,
	INPUT = accessorcorr_in, /* timescaledb_toolkit::accessors::accessorcorr_in */
	OUTPUT = accessorcorr_out, /* timescaledb_toolkit::accessors::accessorcorr_out */
	STORAGE = extended
);

-- extension/src/counter_agg.rs:800
-- timescaledb_toolkit::counter_agg::arrow_counter_agg_corr
CREATE  FUNCTION "arrow_counter_agg_corr"(
	"sketch" CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
...
-- timescaledb_toolkit::counter_agg::arrow_counter_agg_corr
CREATE OPERATOR -> (
	PROCEDURE="arrow_counter_agg_corr",
	LEFTARG=CounterSummary, /* timescaledb_toolkit::counter_agg::CounterSummary */
...
CREATE  FUNCTION "corr"() RETURNS AccessorCorr /* timescaledb_toolkit::accessors::AccessorCorr */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "arrow_stats2d_corr"(
	"sketch" StatsSummary2D, /* timescaledb_toolkit::stats_agg::StatsSummary2D */
	"_accessor" AccessorCorr /* timescaledb_toolkit::accessors::AccessorCorr */
) RETURNS double precision /* core::option::Option<f64> */
IMMUTABLE STRICT PARALLEL SAFE
...
CREATE TYPE AccessorAverageY;

-- extension/src/accessors.rs:66
-- timescaledb_toolkit::accessors::accessoraveragey_in
CREATE  FUNCTION "accessoraveragey_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessoraveragey_out"(
...
CREATE TYPE AccessorAverageY (
	INTERNALLENGTH = variable,
	INPUT = accessoraveragey_in, /* timescaledb_toolkit::accessors::accessoraveragey_in */
	OUTPUT = accessoraveragey_out, /* timescaledb_toolkit::accessors::accessoraveragey_out */
	STORAGE = extended
);

-- extension/src/accessors.rs:66
-- timescaledb_toolkit::accessors::average_y
CREATE  FUNCTION "average_y"() RETURNS AccessorAverageY /* timescaledb_toolkit::accessors::AccessorAverageY */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "arrow_stats2d_average_y"(
	"sketch" StatsSummary2D, /* timescaledb_toolkit::stats_agg::StatsSummary2D */
...
-- timescaledb_toolkit::stats_agg::arrow_stats2d_average_y
CREATE OPERATOR -> (
	PROCEDURE="arrow_stats2d_average_y",
	LEFTARG=StatsSummary2D, /* timescaledb_toolkit::stats_agg::StatsSummary2D */
	RIGHTARG=AccessorAverageY /* timescaledb_toolkit::accessors::AccessorAverageY */
);

-- extension/src/accessors.rs:65
-- timescaledb_toolkit::accessors::AccessorAverageX
CREATE TYPE AccessorAverageX;

-- extension/src/accessors.rs:65
-- timescaledb_toolkit::accessors::accessoraveragex_in
CREATE  FUNCTION "accessoraveragex_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessoraveragex_out"(
...
CREATE TYPE AccessorAverageX (
	INTERNALLENGTH = variable,
	INPUT = accessoraveragex_in, /* timescaledb_toolkit::accessors::accessoraveragex_in */
	OUTPUT = accessoraveragex_out, /* timescaledb_toolkit::accessors::accessoraveragex_out */
	STORAGE = extended
);

-- extension/src/accessors.rs:65
-- timescaledb_toolkit::accessors::average_x
CREATE  FUNCTION "average_x"() RETURNS AccessorAverageX /* timescaledb_toolkit::accessors::AccessorAverageX */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "arrow_stats2d_average_x"(
	"sketch" StatsSummary2D, /* timescaledb_toolkit::stats_agg::StatsSummary2D */
...
-- timescaledb_toolkit::stats_agg::arrow_stats2d_average_x
CREATE OPERATOR -> (
	PROCEDURE="arrow_stats2d_average_x",
	LEFTARG=StatsSummary2D, /* timescaledb_toolkit::stats_agg::StatsSummary2D */
	RIGHTARG=AccessorAverageX /* timescaledb_toolkit::accessors::AccessorAverageX */
);

-- extension/src/accessors.rs:64
-- timescaledb_toolkit::accessors::AccessorAverage
CREATE TYPE AccessorAverage;

-- extension/src/accessors.rs:64
-- timescaledb_toolkit::accessors::accessoraverage_in
CREATE  FUNCTION "accessoraverage_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessoraverage_out"(
...
CREATE TYPE AccessorAverage (
	INTERNALLENGTH = variable,
	INPUT = accessoraverage_in, /* timescaledb_toolkit::accessors::accessoraverage_in */
	OUTPUT = accessoraverage_out, /* timescaledb_toolkit::accessors::accessoraverage_out */
	STORAGE = extended
);

-- extension/src/time_weighted_average.rs:429
-- timescaledb_toolkit::time_weighted_average::arrow_time_weighted_average_average
CREATE  FUNCTION "arrow_time_weighted_average_average"(
...
-- timescaledb_toolkit::time_weighted_average::arrow_time_weighted_average_average
CREATE OPERATOR -> (
	PROCEDURE="arrow_time_weighted_average_average",
	LEFTARG=TimeWeightSummary, /* core::option::Option<timescaledb_toolkit::time_weighted_average::TimeWeightSummary> */
	RIGHTARG=AccessorAverage /* timescaledb_toolkit::accessors::AccessorAverage */
);

-- extension/src/accessors.rs:64
-- timescaledb_toolkit::accessors::average
CREATE  FUNCTION "average"() RETURNS AccessorAverage /* timescaledb_toolkit::accessors::AccessorAverage */
IMMUTABLE STRICT PARALLEL SAFE 
LANGUAGE c /* Rust */
...
CREATE  FUNCTION "arrow_stats1d_average"(
	"sketch" StatsSummary1D, /* timescaledb_toolkit::stats_agg::StatsSummary1D */
	"_accessor" AccessorAverage /* timescaledb_toolkit::accessors::AccessorAverage */
) RETURNS double precision /* core::option::Option<f64> */
IMMUTABLE STRICT PARALLEL SAFE
...
-- timescaledb_toolkit::stats_agg::arrow_stats1d_average
CREATE OPERATOR -> (
	PROCEDURE="arrow_stats1d_average",
	LEFTARG=StatsSummary1D, /* timescaledb_toolkit::stats_agg::StatsSummary1D */
	RIGHTARG=AccessorAverage /* timescaledb_toolkit::accessors::AccessorAverage */
);
...
CREATE TYPE AccessorApproxPercentileRank;

-- extension/src/accessors.rs:55
-- timescaledb_toolkit::accessors::accessorapproxpercentilerank_in
CREATE  FUNCTION "accessorapproxpercentilerank_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorapproxpercentilerank_out"(
...
CREATE TYPE AccessorApproxPercentileRank (
	INTERNALLENGTH = variable,
	INPUT = accessorapproxpercentilerank_in, /* timescaledb_toolkit::accessors::accessorapproxpercentilerank_in */
	OUTPUT = accessorapproxpercentilerank_out, /* timescaledb_toolkit::accessors::accessorapproxpercentilerank_out */
	STORAGE = extended
);

-- extension/src/tdigest.rs:351
-- timescaledb_toolkit::tdigest::arrow_tdigest_approx_rank
CREATE  FUNCTION "arrow_tdigest_approx_rank"(
	"sketch" TDigest, /* timescaledb_toolkit::tdigest::TDigest */
...
-- timescaledb_toolkit::tdigest::arrow_tdigest_approx_rank
CREATE OPERATOR -> (
	PROCEDURE="arrow_tdigest_approx_rank",
	LEFTARG=TDigest, /* timescaledb_toolkit::tdigest::TDigest */
	RIGHTARG=AccessorApproxPercentileRank /* timescaledb_toolkit::accessors::AccessorApproxPercentileRank */
);
...
CREATE  FUNCTION "arrow_uddsketch_approx_rank"(
	"sketch" UddSketch, /* timescaledb_toolkit::uddsketch::UddSketch */
	"accessor" AccessorApproxPercentileRank /* timescaledb_toolkit::accessors::AccessorApproxPercentileRank */
) RETURNS double precision /* f64 */
IMMUTABLE STRICT PARALLEL SAFE
...
-- timescaledb_toolkit::uddsketch::arrow_uddsketch_approx_rank
CREATE OPERATOR -> (
	PROCEDURE="arrow_uddsketch_approx_rank",
	LEFTARG=UddSketch, /* timescaledb_toolkit::uddsketch::UddSketch */
	RIGHTARG=AccessorApproxPercentileRank /* timescaledb_toolkit::accessors::AccessorApproxPercentileRank */
);
...
CREATE TYPE AccessorApproxPercentile;

-- extension/src/accessors.rs:51
-- timescaledb_toolkit::accessors::accessorapproxpercentile_in
CREATE  FUNCTION "accessorapproxpercentile_in"(
	"input" cstring /* core::option::Option<&core::ffi::c_str::CStr> */
...
CREATE  FUNCTION "accessorapproxpercentile_out"(
...
CREATE TYPE AccessorApproxPercentile (
	INTERNALLENGTH = variable,
	INPUT = accessorapproxpercentile_in, /* timescaledb_toolkit::accessors::accessorapproxpercentile_in */
	OUTPUT = accessorapproxpercentile_out, /* timescaledb_toolkit::accessors::accessorapproxpercentile_out */
	STORAGE = extended
);

-- extension/src/uddsketch.rs:565
-- timescaledb_toolkit::uddsketch::arrow_uddsketch_approx_percentile
CREATE  FUNCTION "arrow_uddsketch_approx_percentile"(
	"sketch" UddSketch, /* timescaledb_toolkit::uddsketch::UddSketch */
...
-- timescaledb_toolkit::uddsketch::arrow_uddsketch_approx_percentile
CREATE OPERATOR -> (
	PROCEDURE="arrow_uddsketch_approx_percentile",
	LEFTARG=UddSketch, /* timescaledb_toolkit::uddsketch::UddSketch */
	RIGHTARG=AccessorApproxPercentile /* timescaledb_toolkit::accessors::AccessorApproxPercentile */
);

-- extension/src/tdigest.rs:336
-- timescaledb_toolkit::tdigest::arrow_tdigest_approx_percentile
CREATE  FUNCTION "arrow_tdigest_approx_percentile"(
	"sketch" TDigest, /* timescaledb_toolkit::tdigest::TDigest */
	"accessor" AccessorApproxPercentile /* timescaledb_toolkit::accessors::AccessorApproxPercentile */
) RETURNS double precision /* f64 */
IMMUTABLE STRICT PARALLEL SAFE
...
-- timescaledb_toolkit::tdigest::arrow_tdigest_approx_percentile
CREATE OPERATOR -> (
	PROCEDURE="arrow_tdigest_approx_percentile",
	LEFTARG=TDigest, /* timescaledb_toolkit::tdigest::TDigest */
	RIGHTARG=AccessorApproxPercentile /* timescaledb_toolkit::accessors::AccessorApproxPercentile */
);
...
CREATE  FUNCTION "arrow_timevector_asof"(
	"series" Timevector_TSTZ_F64, /* timescaledb_toolkit::time_vector::Timevector_TSTZ_F64 */
...
CREATE  FUNCTION "arrow_run_pipeline"(
...
CREATE  FUNCTION "arrow_add_unstable_element"(
	"pipeline" toolkit_experimental.UnstableTimevectorPipeline, /* timescaledb_toolkit::time_vector::pipeline::toolkit_experimental::UnstableTimevectorPipeline */
...
CREATE  FUNCTION "arrow_run_pipeline_then_unnest"(
	"timevector" Timevector_TSTZ_F64, /* timescaledb_toolkit::time_vector::Timevector_TSTZ_F64 */
...
CREATE  FUNCTION "arrow_finalize_with_unnest"(
	"pipeline" toolkit_experimental.UnstableTimevectorPipeline, /* timescaledb_toolkit::time_vector::pipeline::toolkit_experimental::UnstableTimevectorPipeline */
...
CREATE  FUNCTION "arrow_run_pipeline_then_materialize"(
	"timevector" Timevector_TSTZ_F64, /* timescaledb_toolkit::time_vector::Timevector_TSTZ_F64 */
...
CREATE  FUNCTION "arrow_force_materialize"(
	"pipeline" toolkit_experimental.UnstableTimevectorPipeline, /* timescaledb_toolkit::time_vector::pipeline::toolkit_experimental::UnstableTimevectorPipeline */
...
CREATE  FUNCTION "arrow_pipeline_then_average"(
	"timevector" Timevector_TSTZ_F64, /* timescaledb_toolkit::time_vector::Timevector_TSTZ_F64 */
...
CREATE  FUNCTION "finalize_with_average"(
	"pipeline" toolkit_experimental.UnstableTimevectorPipeline, /* timescaledb_toolkit::time_vector::pipeline::toolkit_experimental::UnstableTimevectorPipeline */
...
CREATE  FUNCTION "arrow_run_pipeline_then_hyperloglog"(
	"timevector" Timevector_TSTZ_F64, /* timescaledb_toolkit::time_vector::Timevector_TSTZ_F64 */
...
CREATE  FUNCTION "arrow_pipeline_then_sum"(
	"timevector" Timevector_TSTZ_F64, /* timescaledb_toolkit::time_vector::Timevector_TSTZ_F64 */
...
CREATE  FUNCTION "finalize_with_sum"(
	"pipeline" toolkit_experimental.UnstableTimevectorPipeline, /* timescaledb_toolkit::time_vector::pipeline::toolkit_experimental::UnstableTimevectorPipeline */
...
CREATE  FUNCTION "arrow_pipeline_then_num_vals"(
	"timevector" Timevector_TSTZ_F64, /* timescaledb_toolkit::time_vector::Timevector_TSTZ_F64 */
...
CREATE  FUNCTION "finalize_with_num_vals"(
	"pipeline" toolkit_experimental.UnstableTimevectorPipeline, /* timescaledb_toolkit::time_vector::pipeline::toolkit_experimental::UnstableTimevectorPipeline */
...
CREATE  FUNCTION "arrow_run_pipeline_then_counter_agg"(
	"timevector" Timevector_TSTZ_F64, /* timescaledb_toolkit::time_vector::Timevector_TSTZ_F64 */
...
CREATE  FUNCTION "arrow_run_pipeline_then_stats_agg"(
	"timevector" Timevector_TSTZ_F64, /* timescaledb_toolkit::time_vector::Timevector_TSTZ_F64 */
...
CREATE  FUNCTION "arrow_run_pipeline_then_percentile_agg"(
	"timevector" Timevector_TSTZ_F64, /* timescaledb_toolkit::time_vector::Timevector_TSTZ_F64 */
...
CREATE  FUNCTION "arrow_irate_left"(
...
CREATE  FUNCTION "arrow_with_bounds"(
	"sketch" toolkit_experimental.GaugeSummary, /* timescaledb_toolkit::gauge_agg::toolkit_experimental::GaugeSummary */
	"accessor" AccessorWithBounds /* timescaledb_toolkit::accessors::AccessorWithBounds */
...
CREATE  FUNCTION "arrow_irate_right"(
	"sketch" toolkit_experimental.GaugeSummary, /* timescaledb_toolkit::gauge_agg::toolkit_experimental::GaugeSummary */
	"_accessor" AccessorIrateRight /* timescaledb_toolkit::accessors::AccessorIrateRight */
) RETURNS double precision /* core::option::Option<f64> */
IMMUTABLE STRICT PARALLEL SAFE
...
CREATE  FUNCTION "arrow_idelta_left"(
	"sketch" toolkit_experimental.GaugeSummary, /* timescaledb_toolkit::gauge_agg::toolkit_experimental::GaugeSummary */
	"_accessor" AccessorIdeltaLeft /* timescaledb_toolkit::accessors::AccessorIdeltaLeft */
) RETURNS double precision /* f64 */
IMMUTABLE STRICT PARALLEL SAFE
...
CREATE  FUNCTION "arrow_intercept"(
	"sketch" toolkit_experimental.GaugeSummary, /* timescaledb_toolkit::gauge_agg::toolkit_experimental::GaugeSummary */
	"_accessor" AccessorIntercept /* timescaledb_toolkit::accessors::AccessorIntercept */
) RETURNS double precision /* core::option::Option<f64> */
IMMUTABLE STRICT PARALLEL SAFE
...
CREATE  FUNCTION "arrow_gauge_agg_rate"(
	"sketch" toolkit_experimental.GaugeSummary, /* timescaledb_toolkit::gauge_agg::toolkit_experimental::GaugeSummary */
	"_accessor" AccessorRate /* timescaledb_toolkit::accessors::AccessorRate */
) RETURNS double precision /* core::option::Option<f64> */
IMMUTABLE STRICT PARALLEL SAFE
...
CREATE  FUNCTION "arrow_idelta_right"(
	"sketch" toolkit_experimental.GaugeSummary, /* timescaledb_toolkit::gauge_agg::toolkit_experimental::GaugeSummary */
	"_accessor" AccessorIdeltaRight /* timescaledb_toolkit::accessors::AccessorIdeltaRight */
) RETURNS double precision /* f64 */
IMMUTABLE STRICT PARALLEL SAFE
...
CREATE  FUNCTION "arrow_num_elements"(
	"sketch" toolkit_experimental.GaugeSummary, /* timescaledb_toolkit::gauge_agg::toolkit_experimental::GaugeSummary */
	"_accessor" AccessorNumElements /* timescaledb_toolkit::accessors::AccessorNumElements */
) RETURNS bigint /* i64 */
IMMUTABLE STRICT PARALLEL SAFE
...
CREATE  FUNCTION "arrow_extrapolated_rate"(
	"sketch" toolkit_experimental.GaugeSummary, /* timescaledb_toolkit::gauge_agg::toolkit_experimental::GaugeSummary */
...
CREATE  FUNCTION "arrow_num_changes"(
	"sketch" toolkit_experimental.GaugeSummary, /* timescaledb_toolkit::gauge_agg::toolkit_experimental::GaugeSummary */
	"_accessor" AccessorNumChanges /* timescaledb_toolkit::accessors::AccessorNumChanges */
) RETURNS bigint /* i64 */
IMMUTABLE STRICT PARALLEL SAFE
...
CREATE  FUNCTION "arrow_time_delta"(
	"sketch" toolkit_experimental.GaugeSummary, /* timescaledb_toolkit::gauge_agg::toolkit_experimental::GaugeSummary */
	"_accessor" AccessorTimeDelta /* timescaledb_toolkit::accessors::AccessorTimeDelta */
) RETURNS double precision /* f64 */
IMMUTABLE STRICT PARALLEL SAFE
...
CREATE  FUNCTION "arrow_zero_time"(
	"sketch" toolkit_experimental.GaugeSummary, /* timescaledb_toolkit::gauge_agg::toolkit_experimental::GaugeSummary */
...
CREATE  FUNCTION "arrow_extrapolated_delta"(
	"sketch" toolkit_experimental.GaugeSummary, /* timescaledb_toolkit::gauge_agg::toolkit_experimental::GaugeSummary */
...
CREATE AGGREGATE state_agg (ts timestamptz, value text) (
    stype = internal,
